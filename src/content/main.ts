import { applyCSSVariable, removeCSSVariable, getCurrentTheme, readCSSVariables } from '@/lib/dom-utils'
import { applyThemePreset, handleThemeSwitch, watchThemeChanges } from '@/lib/theme-manager'
