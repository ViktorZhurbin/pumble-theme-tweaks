import { applyCSSVariable, removeCSSVariable, getCurrentTheme } from './dom-utils.js';
import { getThemePreset, getAllUsedVariableNames } from './storage.js';
import { notifyBadgeUpdate } from './messaging.js';
 ...
 */
export async function applyThemePreset(themeName) {
 ...
 * @returns {Promise<void>}
 */
export async function handleThemeSwitch(newThemeName) {
